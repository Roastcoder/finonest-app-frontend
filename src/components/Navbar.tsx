...
export default function Navbar({
  ...
  return (
    <header style={{ height: 'clamp(3rem, 5vh, 3.5rem)' }} className="w-full fixed top-0 left-0 right-0 border-b border-white/20 dark:border-white/5 flex items-center px-3 lg:px-5 gap-2 lg:gap-4 shrink-0 shadow-sm z-30 bg-white dark:bg-gray-900 backdrop-blur-sm transition-all">
      {/* Logo - Mobile Only */}
