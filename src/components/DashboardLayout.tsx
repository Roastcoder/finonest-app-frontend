  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <aside style={{
        ...
        height: '100vh'
      }} className={`fixed lg:static inset-y-0 left-0 z-[9999] overflow-hidden glass-panel border-r border-white/50 dark:border-white/10 flex flex-col transition-all duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'} shadow-2xl lg:rounded-none`}>
        {/* Logo */}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header style={{ height: 'clamp(3rem, 5vh, 3.5rem)' }} className="hidden lg:flex w-full border-b border-white/20 dark:border-white/5 items-center px-5 gap-4 shrink-0 shadow-sm bg-white dark:bg-gray-900 backdrop-blur-sm transition-all z-40">
          {/* Page Title */}
          ...
          <div className="relative">
            ...
            {profileOpen && (
              <>
                ...
                <div className="absolute right-0 top-12 w-56 glass-panel border border-white/20 dark:border-white/5 rounded-2xl shadow-xl z-50 overflow-hidden transform origin-top-right transition-all backdrop-blur-2xl bg-white/10 dark:bg-black/20">
