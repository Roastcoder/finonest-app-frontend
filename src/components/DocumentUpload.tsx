        ...
        <div>
          ...
          <div className="space-y-4">
            {Object.entries(DOCUMENT_CATEGORIES).map(([categoryKey, category]) => (
              <div key={categoryKey} className="border border-border rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {category.documents.map(doc => (
                    <div key={doc.value} className="flex items-center space-x-2">
                      ...
                      />
                      <label htmlFor={doc.value} className="text-sm font-medium text-foreground cursor-pointer">
                        {doc.label}
                      </label>
                    </div>
                  ))}
        ...
        {selectedDocTypes.length > 0 && (
          <div className="space-y-4">
            ...
            {selectedDocTypes.map(docType => {
              // Find the document label from categories
