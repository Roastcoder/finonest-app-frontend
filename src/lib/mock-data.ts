...
export type ApplicationStage = 'SUBMITTED' | 'LOGIN' | 'IN_PROCESS' | 'REJECTED' | 'APPROVED' | 'DISBURSED' | 'CANCELLED';
...
export const APPLICATION_STAGES: { value: ApplicationStage; label: string; color: string }[] = [
